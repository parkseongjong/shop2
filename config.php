...
*/
#define('G5_DOMAIN', 'https://barrybarries.com');
#define('G5_HTTPS_DOMAIN', 'https://barrybarries.com');

$_BASE_HOST = $_SERVER['HTTP_HOST'] ?? 'barrybarry.market';
define('G5_ENV', strpos($_BASE_HOST, 'barrybarry.market') !== false ? 'production' : 'development');
define('G5_DOMAIN', "https://{$_BASE_HOST}");
define('G5_HTTPS_DOMAIN', "https://{$_BASE_HOST}");
...
//2021.12.02  By. MAIL CLASS 에서 이 상수를 할당 하지 않음. 직접 수정함.
###define('G5_SMTP',      'smtp.gmail.com');
define('G5_SMTP',      false);
