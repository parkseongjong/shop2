...
<?php if (!$wmode) { ?>
    ...
    <footer class="footer">
                ...
                <div class="f-row">
                    <div class="f-col-lg-4">
                        <div class="footer-box footer-customer">
                            <h4>고객센터</h4>
                            <div class="footer-tel"><?php echo $bizinfo['bi_cs_tel1']; ?>
                                <small>(<?php echo $bizinfo['bi_cs_time']; ?>)</small>
                            </div>
                            <div class="footer-email">
                                <a href="mailto:<?php echo $bizinfo['bi_cs_email']; ?>"><?php echo $bizinfo['bi_cs_email']; ?></a>
                            </div>
                    ...
                    <div class="f-col-lg-4">
                        <div class="footer-box footer-bank">
                            ...
                            <ul class="list-unstyled">
                                <?php preg_match_all('/([가-힣]+)[^\d]+([\d\w\-]+)/', $default['de_bank_account'], $matches, PREG_SET_ORDER);
                            ...
                            <address>
                                <?php if ($is_admin == 'super' && !G5_IS_MOBILE) { ?>
                                    <div class="adm-edit-btn btn-edit-mode hidden-xs hidden-sm">
                                        <div class="btn-group">
                                            <a href="<?php echo G5_ADMIN_URL; ?>/?dir=theme&amp;pid=biz_info&amp;amode=biz&amp;thema=<?php echo $theme; ?>&amp;wmode=1" onclick="eb_admset_modal(this.href); return false;" class="btn-e btn-e-xs btn-e-red btn-e-split"><i class="far fa-edit"></i>
                                                기업정보 설정</a>
                                ...
                                <?php } ?>
                                <span class="add"><?php echo $bizinfo['bi_company_zip']; ?> <?php echo $bizinfo['bi_company_addr1']; ?> <?php echo $bizinfo['bi_company_addr2']; ?>
                                    <br> <?php echo $bizinfo['bi_company_addr3']; ?></span><br>
        ...
        <div class="footer-btm">
            <?php /* copyright */ ?>
            <div class="copyright">Copyright &copy; <strong><?php echo $config['cf_title']; ?></strong>. All Rights
                Reserved.
            </div>
        </div>
    </footer>
