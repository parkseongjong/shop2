                    ...
                    <?php if (true) {
                        ...
                        foreach ($categories as $category) {
                            ...
                            if ($has_child === 'true') {
                                ...
                                print "<li class=\"division\">";
                                print "<a href=\"{$category['link']}\">{$category['title']}</a>";
                                print "</li>";
                            }

                        }
                    }
                    else if (isset($menu) && is_array($menu)) { ?>
            ...
            <ul class="list-unstyled">
                <li class="hidden-md hidden-lg text-center">
                    <a href="<?php echo G5_SHOP_URL; ?>">
                        ...
                        <p class="hidden-md hidden-lg">홈</p>
                    </a>
                </li>
                <li class="text-center">
                    <a href="#" data-toggle="modal" data-target=".search-contents-modal">
                        ...
                        <p class="hidden-md hidden-lg">검색</p>
                    </a>
                </li>

                <li class="text-center">
                    <a href="<?php echo G5_SHOP_URL; ?>/cart.php">
                        <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_bag.png" alt="장바구니"><em><?php echo get_boxcart_datas_count(); ?></em>
                        <p class="hidden-md hidden-lg">장바구니</p>
                    </a>
                </li>
                <!-- li class="btn-latest-goods text-center">
                    <a href="">
                        <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_clock.png" alt="최근본상품">
                        <em><?php echo get_wishlist_datas_count(); ?></em>
                        <p>최근본상품</p>
                    </a>
                </li -->
                <li class="text-center">
                    <a href="<?php echo $is_member ? G5_SHOP_URL . '/mypage.php' : G5_BBS_URL . '/login.php' ?>">
                        <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_user.png" alt="마이페이지">
                        <p class="hidden-md hidden-lg">마이페이지</p>
                    </a>
                </li>
                ...
                <li class="hidden-md hidden-lg text-center">
                    <?php if ($is_member) { // 회원일 경우 ?>
                        <a href="<?php echo G5_BBS_URL; ?>/logout.php">
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_power.png" alt="로그아웃">
                            <p class="hidden-md hidden-lg">로그아웃</p>
                        </a>
                    <?php } else { ?>
                        <a href="<?php echo G5_BBS_URL; ?>/login.php">
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_sign_in.png" alt="로그인">
                            <p class="hidden-md hidden-lg">로그인</p>
                        </a>
                    <?php } ?>
                </li>

                <!-- li class="btn-mo-nav hidden-md hidden-lg text-center">
                    <a href=""><img src="<?php echo EYOOM_THEME_URL; ?>/image/icons/icon_bar.png" alt="메뉴"><p>메뉴</p></a>
                </li -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="search-contents">
                        <form name="fsearchbox" method="get" action="<?php echo G5_SHOP_URL; ?>/search.php" onsubmit="return fsearchbox_submit(this);" class="eyoom-form">
                            <input type="hidden" name="sfl" value="wr_subject||wr_content">
                            <input type="hidden" name="sop" value="and">
                            <label for="modal_sch_stx" class="sound_only"><strong>검색어 입력 필수</strong></label>
                            <div class="input input-button">
                                <input type="text" name="stx" id="modal_sch_stx" class="sch_stx" maxlength="20" placeholder="상품 검색어 입력">
...
<main class="basic-body <?php if (!defined('_INDEX_')) { ?>sub-basic-body<?php } ?>">
    ...
    <div class="f-container basic-page-content">
    <div class="f-row">
<?php } ?>
