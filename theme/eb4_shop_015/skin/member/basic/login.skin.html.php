                ...
                <div class="login-form">
                    ...
                    <section>
                        ...
                        <label class="input">
                            ...
                            <input type="text" name="mb_id" placeholder="ID" class="frm_input required" size="20" maxLength="20" autocomplete="username" required>
                        </label>
                    </section>
                    ...
                    <section>
                        ...
                        <label class="input">
                            ...
                            <input type="password" name="mb_password" placeholder="Password" class="frm_input required" size="20" autocomplete="off" maxLength="20" required>
                        </label>
                    </section>
                    <div class="login-form-margin-bottom"></div>
