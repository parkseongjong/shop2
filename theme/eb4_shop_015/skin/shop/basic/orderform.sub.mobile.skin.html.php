...
<style>
    ...
    .shop-order-form .payment-select-wrap .payment-select-box {padding-left: 52px !important;}
    .eyoom-form .inline-group .checkbox, .eyoom-form .inline-group .radio {float: left;margin-right: .75rem;padding-left: 20px;}
</style>
                ...
                <li class="sod-li">
                    ...
                    <div class="li-op-wrap">
                        ...
                        <?php if ($sod_list[$i]['cp_count']) { ?>
                            <div class="li-mod">
                                <button type="button" class="btn-e btn-e-dark cp_btn" data-toggle="modal" data-target="#modal_coupon_apply">
                                    쿠폰적용
                                </button>
                            </div>
                        <?php } ?>
                    ...
                    <div class="total_price total-span">
                        <span>주문금액 </span><strong><?php echo number_format($sod_list[$i]['sell_price']); ?></strong>
                    </div>
                </li>
            <?php } ?>
        <?php } ?>
                ...
                <div class="order-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="od_name" class="hidden-lg hidden-md">이름<strong class="sound_only">
                                        필수</strong></label>
                        ...
                        <?php if (!$is_member) { // 비회원이면 ?>
                            <tr>
                                ...
                                <td>
                                    <label for="od_pwd" class="hidden-lg hidden-md">비밀번호<strong class="sound_only">
                                            필수</strong></label>
                                    <label class="input width-200px required-mark">
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="od_hp" class="hidden-lg hidden-md">연락처</label>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn-e btn-e-lg btn-e-red" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">
                                    주소 검색
                                </button>
                        ...
                        <tr>
                            <th scope="row"><label for="od_email">E-mail<strong class="sound_only"> 필수</strong></label>
                            </th>
                            <td>
                                <label for="od_email" class="hidden-lg hidden-md">E-mail<strong class="sound_only">
                                        필수</strong></label>
                                <label class="input width-200px required-mark">
                ...
                <div class="order-table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="hidden-lg hidden-md" style="display: flex">
                                    <span style="flex-grow: 1">배송지선택</span>
                                    <a href="<?php echo G5_SHOP_URL; ?>/orderaddress.php" id="order_address_mobtn" class="btn-e btn-e-dark">배송지목록</a>
                                </label>
                                <div class="inline-group">
                                    <?php if ($is_member) { ?>
                                        <label for="ad_sel_addr_same" class="radio"><input type="radio" name="ad_sel_addr" value="same" id="ad_sel_addr_same"><i class="rounded-x"></i>주문자와
                                            동일</label>
                                        <?php if ($ad_sel_addr) { ?>
                                        ...
                                        <?php if (is_array($latest_addr)) { ?>
                                            <?php foreach ($latest_addr as $k => $addrinfo) { ?>
                                                <label for="ad_sel_addr_<?php echo($k + 1); ?>" class="radio"><input type="radio" name="ad_sel_addr" value="<?php echo $addrinfo['val1']; ?>" id="ad_sel_addr_<?php echo($k + 1); ?>"><i class="rounded-x"></i>최근배송지(<?php echo $addrinfo['ad_subject'] ? $addrinfo['ad_subject'] : $addrinfo['ad_name']; ?>
                                                    )</label>
                                            <?php } ?>
                                        <?php } ?>
                                        ...
                                        <!-- a href="<?php echo G5_SHOP_URL; ?>/orderaddress.php" id="order_address_mobtn" class="hidden-sm btn-e btn-e-dark">배송지목록</a -->
                                    <?php } else { ?>
                                        <label for="ad_sel_addr_same" class="checkbox"><input type="checkbox" name="ad_sel_addr" value="same" id="ad_sel_addr_same"><i class="rounded-x"></i>주문자와
                                            동일</label>
                                    <?php } ?>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="od_b_name" class="hidden-lg hidden-md">이름<strong class="sound_only">
                                        필수</strong></label>
                                <label class="input width-200px required-mark">
                        ...
                        <!-- tr>
                            <th scope="row"><label for="od_b_tel">전화번호<strong class="sound_only"> 필수</strong></label>
                            </th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td id="sod_frm_addr">
                                ...
                                <button type="button" class="btn-e btn-e-lg btn-e-red" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">
                                    주소 검색
                                </button>
                                <div class="clearfix margin-bottom-10"></div>
                                <label for="od_b_addr1" class="sound_only">기본주소<strong class="sound_only">
                                        필수</strong></label>
                                <label class="input required-mark">
        ...
        <div class="order-payment-info">
            ...
            <?php if ($oc_cnt > 0) { ?>
                <div class="payment-info-box">
                    ...
                    <button type="button" id="od_coupon_btn" class="btn-e btn-e-dark" data-toggle="modal" data-target="#modal_od_coupon_apply">
                        쿠폰적용
                    </button>
                </div>
                <div class="payment-info-box">
            ...
            <div class="payment-select-wrap">
                ...
                <?php if (!$default['de_card_point']) { ?>
                    <p class="color-grey font-size-11">* <strong>무통장입금</strong> 이외의 결제 수단으로 결제하시는 경우 포인트를 적립해드리지 않습니다.
                    </p>
                <?php } ?>
                ...
                <div id="m_sod_frm_paysel">
                    ...
                    <?php if ($default['de_vbank_use']) {
                        ...
                        <label for="od_settle_vbank" class="payment-select-box vbank_icon"><?php echo $escrow_title; ?>
                            가상계좌</label>
                        <?php $checked = '';
                    } ?>
                    ...
                    <?php if ($default['de_iche_use']) {
                        ...
                        <label for="od_settle_iche" class="payment-select-box iche_icon"><?php echo $escrow_title; ?>
                            계좌이체</label>
                        <?php $checked = '';
                    } ?>
                    ...
                    <?php if ($default['de_card_use']) {
                        ...
                        <label for="od_settle_card" class="payment-select-box card_icon">신용카드</label>
                        <?php $checked = '';
                    } ?>
                    ...
                    <?php if ($default['de_inicis_kakaopay_use']) { // 이니시스 카카오페이 ?>
                        ...
                        <label for="od_settle_inicis_kakaopay" class="payment-select-box inicis_kakaopay">KG 이니시스
                            카카오페이</label>
                        <?php $checked = '';
                    } ?>
                    ...
                    <?php if ($default['de_samsung_pay_use']) { // 이니시스 삼성페이 ?>
                        <input type="radio" id="od_settle_samsungpay" data-case="samsungpay" name="od_settle_case" value="삼성페이" <?php echo $checked; ?>>
                        <label for="od_settle_samsungpay" class="payment-select-box samsung_pay">삼성페이</label>
                        <?php $checked = '';
                    } ?>
                    ...
                    <?php if ($temp_point) { // 회원이면서 포인트사용이면 ?>
                        <div class="payment-point-use-box">
                            <div class="payment-point-use">
                                <label for="od_temp_point" class="pull-left">사용 포인트(<?php echo $point_unit; ?>점
                                    단위)</label>
                            ...
                            <div class="payment-point-use">
                                ...
                                <div class="clearfix"></div>
                                <strong class="pull-left">최대 사용 가능
                                    포인트</strong><strong class="pull-right color-black"><?php echo display_point($temp_point); ?></strong>
                            </div>
                        </div>
                        <?php $multi_settle++;
                    } ?>
...
<script>
    ...
    function pay_approval() {
        ...
        var f = document.forms['sm_form'],
            frmOrd = document.forms['forderform'];
        ...
        // 필드체크
        if (!orderfield_check(frmOrd)) {
            return false;
        }
        // 금액체크
        else if (!payment_check(frmOrd)) {
            return false;
        }
        // 무통장인 경우 PG 없이 처리
        ...
        if (settle_method == "KAKAOPAY") {
            ...
            <?php } ?>
            frmOrd.good_mny.value = f.good_mny.value;
            getTxnId(frmOrd);
            return false;
        }
        ...
        else if (settle_method == "간편결제" && jQuery("input[name='od_settle_case']:checked").attr("data-pay") === "naverpay") {
        ...
        f.buyr_name.value = frmOrd.od_name.value;
        f.buyr_mail.value = frmOrd.od_email.value;
        f.buyr_tel1.value = frmOrd.od_tel.value;
        f.buyr_tel2.value = frmOrd.od_hp.value;
        f.rcvr_name.value = frmOrd.od_b_name.value;
        f.rcvr_tel1.value = frmOrd.od_b_tel.value;
        f.rcvr_tel2.value = frmOrd.od_b_hp.value;
        f.rcvr_mail.value = frmOrd.od_email.value;
        f.rcvr_zipx.value = frmOrd.od_b_zip.value;
        f.rcvr_add1.value = frmOrd.od_b_addr1.value;
        f.rcvr_add2.value = frmOrd.od_b_addr2.value;
        ...
        if (settle_method == "간편결제") {
            ...
            switch (nhnkcp_easy_pay) {
                case 'naverpay':
                    typeof f.naverpay_direct !== "undefined" && (f.naverpay_direct.value = "Y");
                    break;
                case 'kakaopay':
                    typeof f.kakaopay_direct !== "undefined" && (f.kakaopay_direct.value = "Y");
                    break;
                default:
                    typeof f.payco_direct !== "undefined" && (f.payco_direct.value = "Y");
                    break;
            }

            // 대소문자 구분
            typeof f.ActionResult !== "undefined" && (f.ActionResult.value = "CARD");
            typeof f.pay_method !== "undefined" && (f.pay_method.value = "card");
        }
        <?php
        /*
        | --------------------------------
        ...
        */
        ...
        f.LGD_CUSTOM_FIRSTPAY.value = ['SC0030', 'SC0040', 'SC0060', 'SC0010', 'PAYNOW'][['계좌이체', '가상계좌', '휴대폰', '신용카드', '간편결제'].indexOf(settle_method)];
        f.LGD_EASYPAY_ONLY.value = settle_method == '간편결제' ? 'PAYNOW' : '';

        f.LGD_BUYER.value = frmOrd.od_name.value;
        f.LGD_BUYEREMAIL.value = frmOrd.od_email.value;
        f.LGD_BUYERPHONE.value = frmOrd.od_hp.value;
        f.LGD_AMOUNT.value = f.good_mny.value;

        <?php if($default['de_tax_flag_use']) { ?>
        f.LGD_TAXFREEAMOUNT.value = frmOrd.comm_free_mny.value;
        <?php } ?>
        ...
        */
        ...
        var paymethod = ['bank', 'vbank', 'mobile'][['계좌이체', '가상계좌', '휴대폰'].indexOf(settle_method)] || 'wcard';
        ...
        f.P_UNAME.value = frmOrd.od_name.value;
        f.P_MOBILE.value = frmOrd.od_hp.value;
        f.P_EMAIL.value = frmOrd.od_email.value;
        <?php if($default['de_tax_flag_use']) { ?>
        f.P_TAX.value = frmOrd.comm_vat_mny.value;
        f.P_TAXFREE = frmOrd.comm_free_mny.value;
        <?php } ?>
        ...
        */
        ...
        ?>
        // 주문 정보 임시저장
        var order_data = $(frmOrd).serialize();
        var save_result = "";
        $.ajax({
            type: "POST",
            data: order_data,
        ...
        <?php if($default['de_pg_service'] == 'payup'):?>
        checkoutPayup(frmOrd, settle_method);
        <?php else :?>
        return form_submit();
        <?php endif; ?>
    }
    ...
    function payment_check(f) {
        ...
        typeof(f.max_temp_point) != "undefined" && (max_point = f.max_temp_point.value * 1);
