...
$check_sanitize_keys = array(
    ...
    'de_payup_mid',                 //페이업 아이디1
    'de_payup_secret',              //페이업 인증키1
    'de_payup_mid2',                //페이업 아이디2(가상계좌)
    'de_payup_secret2',             //페이업 인증키2
...
if ($_POST['amode'] == 'ittype') {
    ...
    $sql = " update {$g5['g5_shop_default_table']}
                set de_admin_company_owner        = '{$de_admin_company_owner}',
                    ...
                    -- @changelog 2022.06.23 Lee, Namdu
                    -- Payup 결제 계정 정보 
                    de_payup_mid = '{$de_payup_mid}',
                    de_payup_secret = '{$de_payup_secret}',
                    
                    de_payup_mid2 = '{$de_payup_mid2}',
                    de_payup_secret2 = '{$de_payup_secret2}'
                    ";
    ...
    $bizinfo['bi_company_name'] = $de_admin_company_name;
    $bizinfo['bi_company_bizno'] = $de_admin_company_saupja_no;
    $bizinfo['bi_company_ceo'] = $de_admin_company_owner;
    $bizinfo['bi_company_tel'] = $de_admin_company_tel;
    $bizinfo['bi_company_fax'] = $de_admin_company_fax;
    $bizinfo['bi_company_sellno'] = $de_admin_tongsin_no;

    $bizinfo['bi_company_bugano'] = $de_admin_buga_no;

    $bizinfo['bi_company_infoman'] = $de_admin_info_name;
    $bizinfo['bi_company_infomail'] = $de_admin_info_email;
    $bizinfo['bi_company_zip'] = $de_admin_company_zip;
    $bizinfo['bi_company_addr1'] = $de_admin_company_addr;

    $bizinfo_config_file = G5_DATA_PATH . '/bizinfo/bizinfo.'.$shop_theme.'.config.php';
