...
if ($is_admin != 'super' && $is_admin != 'operator') $sql_common .= " and b.ca_mb_id = '{$member['mb_id']}'";
$sql_common .= ") ";
...
foreach ($list as &$item) {
    $item['href']= shop_item_url($item['it_id']);
    $item['image'] = str_replace("\"","'",get_it_image($item['it_id'], 160, 160));
    $item['it_name'] = preg_replace('/\r\n|\r|\n/', '', $item['it_name']);
}
