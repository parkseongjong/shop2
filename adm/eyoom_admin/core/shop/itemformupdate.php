...
$it_1 = isset($_POST['it_1']) ? intval($_POST['it_1']) : '';
$it_2 = isset($_POST['it_2']) ? intval($_POST['it_2']) : '';




if ($is_admin != 'super' && $is_admin != 'operator') {     // 최고관리자가 아니면 체크
    if( $w === '' ){
 ...
 * - 대리점 영업 수당 추가
 */
is_checked('chk_ca_it_1') && ($ca_fields .= " , it_1 = '$it_1' ");
 ...
 * - 대리점 영업 수당 추가
 */
is_checked('chk_all_it_1') && ($all_fields .= " , it_1 = '$it_1' ");
