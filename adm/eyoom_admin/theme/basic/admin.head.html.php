...
add_stylesheet('<link rel="stylesheet" href="'.EYOOM_ADMIN_THEME_URL.'/css/style.css?v=' . G5_CSS_VER . '" type="text/css" media="screen">',0);
add_stylesheet('<link rel="stylesheet" href="' . EYOOM_ADMIN_THEME_URL . '/css/custom.css?v=' . G5_CSS_VER . '" type="text/css" media="screen">', 0);
add_javascript('<script type="text/javascript" src="' . EYOOM_ADMIN_THEME_URL . '/js/export.js?v=' . G5_JS_VER . '"></script>');
?>
...
<div class="wrapper">
    ...
    <div id="sidebar_left_scroll" class="eb-sidebar-left">
        ...
        <ul class="eb-sidebar-left-menu">
            ...
            <?php for($i=0; $i<count((array)$admmenu); $i++) { if(empty($admmenu[$i]['submenu'])) continue;?>
    ...
    <div class="eb-header">
        ...
        <div class="eb-header-nav">
            <ul class="list-unstyled list-inline">
                ...
                <?php if ($is_youngcart) { ?>
                <li><a href="<?php echo G5_SHOP_URL; ?>/?shop_theme=<?php echo $eyoom_default['shop_theme']; ?>" target="_blank">쇼핑몰</a></li>
                <?php } ?>
