            ...
            <div class="table-list-eb">
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <th class="table-form-th">
                                <label for="it_point" class="label">영업 지급 포인트</label>
                            </th>
                            <td>
                                <label class="input form-width-250px">
                                    <i class="icon-append">점</i>
                                    <input type="number" size="4" name="it_1" value="<?php echo $it['it_1'] > 0 ? $it['it_1'] : 100; ?>" id="it_1">
                                </label>
                                <div class="note">
                                    <strong>Note:</strong> 대리점에게 지급할 영업 지급 포인트 입니다. 회원 지급 포인트에서 차감됩니다.<br />
                                    <span class="color-indigo">회원 지급 포인트 - 영업 지급 포인트 = 회원 실 지급 포인트.</span>
                                </div>
                            </td>
                            <td class="table-chk-td">
                                <div class="inline-group">
                                    <label for="chk_ca_it_1" class="checkbox"><input type="checkbox" name="chk_ca_it_1" value="1" id="chk_ca_it_1"><i></i>분류적용</label>
                                    <label for="chk_all_it_1" class="checkbox"><input type="checkbox" name="chk_all_it_1" value="1" id="chk_all_it_1"><i></i>전체적용</label>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: inline-flex">
                                    ...
                                    <label class="checkbox" style="margin-left:.75rem;font-weight: bold;color:#0066FF">
                                        <input type="checkbox" name="it_2" value="1" id="it_2" <?php echo ($it['it_2']) ? "checked" : ""; ?>><i></i>
                                        주문 제한없음
                                    </label>
