...
?>
    ...
    <style>
        .scf_cardtest_btn {vertical-align: bottom;margin-top:5px;}
        ...
        .btn-group-md > .btn {font-size: 14px;padding: .75rem 1.375rem; font-weight: bolder}
        .btn-tab-toggle.active { color: #fff;background-color: #d9534f;border-color: #d43f3a;}
        .margin-bottom-20 {margin-bottom: 20px !important;}
        .adm-table-form-wrap {border-left: 0; border-right: 0}
        .adm-table-form-wrap table.table {border-left: 1px solid #cacaca; border-right: 1px solid #cacaca}
        table.table .tbl-title {font-size: 14px;line-height: 1;padding: .5rem; text-align: left !important;font-weight: bold;background-color: #e8e9ec}
        .pg-provider, .pg_vbank_url, .pg-note {display: none;}
    </style>
        ...
        <form name="fconfig" method="post" action="<?php echo $action_url1; ?>" enctype="multipart/form-data" class="eyoom-form">
            ...
            <?php if (!$amode) { ?>
                <div id="anc_scf_info">
                    ...
                    <div class="adm-table-form-wrap margin-bottom-30">
                        <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 사업자정보</strong>
                        </header>
                        <fieldset>
                ...
                <div id="anc_scf_skin">
                    ...
                    <div class="adm-table-form-wrap margin-bottom-30">
                        <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 스킨설정</strong>
                        </header>
                        <fieldset>
                            <div class="cont-text-bg">
                                <p class="bg-danger font-size-12 margin-bottom-0">
            ...
            <?php if (!$amode || $amode == 'ittype') { ?>
                <div id="anc_scf_index">
                    ...
                    <div class="adm-table-form-wrap margin-bottom-30">
                        <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 쇼핑몰 초기화면</strong>
                        </header>
                        <fieldset>
                            <div class="cont-text-bg">
                                <p class="bg-danger font-size-12 margin-bottom-0">
                                    <i class="fas fa-info-circle"></i> 상품관리에서 선택한 상품의 타입대로 쇼핑몰 초기화면에 출력합니다. (상품 타입
                                    히트/추천/최신/인기/할인)<br>
                ...
                <?php if (0) { //모바일 쇼핑몰 초기화면 설정 숨김 처리 시작 (해당 기능 불필요) ?>
                    <div id="anc_mscf_index">
                        ...
                        <div class="adm-table-form-wrap margin-bottom-30">
                            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 모바일 쇼핑몰 초기화면 설정</strong>
                            </header>
                            <fieldset>
                                <div class="cont-text-bg">
                                    <p class="bg-danger font-size-12 margin-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type1_list_mod" class="label">1줄당 이미지
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type1_list_row" class="label">출력할 줄
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type1_img_width" class="label">이미지
                                                            폭</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type1_img_height" class="label">이미지
                                                            높이</label>
                                                        <label class="input">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type2_list_mod" class="label">1줄당 이미지
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type2_list_row" class="label">출력할 줄
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type2_img_width" class="label">이미지
                                                            폭</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type2_img_height" class="label">이미지
                                                            높이</label>
                                                        <label class="input">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type3_list_mod" class="label">1줄당 이미지
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type3_list_row" class="label">출력할 줄
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type3_img_width" class="label">이미지
                                                            폭</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type3_img_height" class="label">이미지
                                                            높이</label>
                                                        <label class="input">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type4_list_mod" class="label">1줄당 이미지
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type4_list_row" class="label">출력할 줄
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type4_img_width" class="label">이미지
                                                            폭</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type4_img_height" class="label">이미지
                                                            높이</label>
                                                        <label class="input">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type5_list_mod" class="label">1줄당 이미지
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type5_list_row" class="label">출력할 줄
                                                            수</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type5_img_width" class="label">이미지
                                                            폭</label>
                                                        <label class="input">
                                                    ...
                                                    <div class="col col-2">
                                                        <label for="de_mobile_type5_img_height" class="label">이미지
                                                            높이</label>
                                                        <label class="input">
                        ...
                        <div class="table-list-eb">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table margin-bottom-20">
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_bank_use" name="de_bank_use">
                                                    <option value="0" <?php echo get_selected($default['de_bank_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_bank_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문시 무통장으로 입금을 가능하게
                                                할것인지를 설정합니다.<br>사용할 경우 은행계좌번호를 반드시 입력하여 주십시오.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 무통장 계좌번호를 입력해 주세요.
                                                엔터를 입력하여 여러개의 계좌번호를 등록하실 수 있습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_iche_use" name="de_iche_use">
                                                    <option value="0" <?php echo get_selected($default['de_iche_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_iche_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문시 실시간 계좌이체를 가능하게
                                                할것인지를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select name="de_vbank_use" id="de_vbank_use">
                                                    <option value="0" <?php echo get_selected($default['de_vbank_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_vbank_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문별로 유일하게 생성되는 일회용
                                                계좌번호입니다. 주문자가 가상계좌에 입금시 상점에 실시간으로 통보가 되므로 업무처리가 빨라집니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <?php if (!G5_IS_MOBILE) { ?>
                                        <tr class="pg_vbank_url" data-provider="kcp">
                                            <th class="table-form-th">
                                                <label class="label">NHN KCP 가상계좌 입금통보 URL</label>
                                            </th>
                                            <td>
                                                <?php echo G5_SHOP_URL; ?>/settle_kcp_common.php<br>
                                                <div class="note margin-bottom-10"><strong>Note:</strong> NHN KCP 가상계좌
                                                    사용시 위 주소를 <strong><a href="http://admin.kcp.co.kr" target="_blank">NHN
                                                            KCP 관리자</a> &gt; 상점정보관리 &gt; 정보변경 &gt; 공통URL 정보 &gt; 공통URL
                                                        변경후</strong>에 넣으셔야 상점에 자동으로 입금 통보됩니다.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr class="pg_vbank_url" data-provider="inicis">
                                            <th class="table-form-th">
                                                <label class="label">KG이니시스 가상계좌 입금통보 URL</label>
                                            </th>
                                            <td>
                                                <?php echo G5_SHOP_URL; ?>/settle_inicis_common.php<br>
                                                <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스 가상계좌
                                                    사용시 위 주소를
                                                    <strong><a href="https://iniweb.inicis.com/" target="_blank">KG이니시스
                                                            관리자</a> &gt; 거래조회 &gt; 가상계좌 &gt; 입금통보방식선택 &gt; URL 수신
                                                        설정</strong>에 넣으셔야 상점에 자동으로 입금 통보됩니다.
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_hp_use" name="de_hp_use">
                                                    <option value="0" <?php echo get_selected($default['de_hp_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_hp_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문시 휴대폰 결제를 가능하게
                                                할것인지를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_card_use" name="de_card_use">
                                                    <option value="0" <?php echo get_selected($default['de_card_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_card_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문시 신용카드 결제를 가능하게
                                                할것인지를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="table-form-th">
                                            <label for="de_card_noint_use" class="label">신용카드 무이자할부사용<br>(KCP 만
                                                해당)</label>
                                        </th>
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_card_noint_use" name="de_card_noint_use">
                                                    <option value="0" <?php echo get_selected($default['de_card_noint_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_card_noint_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문시 신용카드 무이자할부를
                                                가능하게 할것인지를 설정합니다.<br>사용으로 설정하시면 KCP PG사 가맹점 관리자 페이지에서 설정하신 무이자할부 설정이
                                                적용됩니다.<br>사용안함으로 설정하시면 PG사 무이자 이벤트 카드를 제외한 모든 카드의 무이자 설정이 적용되지 않습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_easy_pay_use" name="de_easy_pay_use">
                                                    <option value="0" <?php echo get_selected($default['de_easy_pay_use'], 0); ?>>
                                                        노출안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_easy_pay_use'], 1); ?>>
                                                        노출함
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문서 작성 페이지에 PG사
                                                간편결제(PAYCO, PAYNOW, KPAY) 버튼의 별도 사용 여부를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_taxsave_use" name="de_taxsave_use">
                                                    <option value="0" <?php echo get_selected($default['de_taxsave_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_taxsave_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 관리자는 설정에 관계없이
                                                <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=orderlist">주문내역</a>
                                                &gt; 보기에서 발급이 가능합니다.<br>현금영수증 발급 취소는 PG사에서 지원하는 현금영수증 취소 기능을 사용하시기 바랍니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="checkbox" for="de_taxsave_types_account"><input type="checkbox" id="de_taxsave_types_account" name="de_taxsave_types_account" value="account" <?php echo $account_checked; ?> ><i></i>
                                                무통장입금</label>
                                            <label class="checkbox" for="de_taxsave_types_vbank"><input type="checkbox" id="de_taxsave_types_vbank" name="de_taxsave_types_vbank" value="vbank" <?php echo $vbank_checked; ?> ><i></i>
                                                가상계좌</label>
                                            <label class="checkbox" for="de_taxsave_types_transfer"><input type="checkbox" id="de_taxsave_types_transfer" name="de_taxsave_types_transfer" value="transfer" <?php echo $transfer_checked; ?> ><i></i>
                                                실시간계좌이체</label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 현금영수증 발급 사용일 경우
                                                해당됩니다.<br>현금 영수증 발급은 무통장입금, 가상계좌, 실시간계좌에만 적용됩니다.<br>아래 체크된 수단에 한해서 회원이
                                                직접 주문 보기 페이지에서 현금영수증을 발급 받을수 있습니다.<br>!!! 만약 PG사 상점관리자에서 가상계좌 또는
                                                실시간계좌이체가 자동으로 현금영수증이 발급되는 경우이면, 아래 가상계좌와 실시간계좌이체 체크박스를 해제하여 사용해 주세요.(
                                                중복으로 발급되는 것을 막기 위함입니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong>
                                                <a href="<?php echo G5_ADMIN_URL; ?>/?dir=shop&amp;pid=config_form#frm_board">환경설정</a>
                                                &gt; 기본환경설정</a>과 동일한 설정입니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 회원의 포인트가 설정값 이상일
                                                경우만 주문시 결제에 사용할 수 있습니다. 포인트 사용을 하지 않는 경우에는 의미가 없습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문 결제시 최대로 사용할 수
                                                있는 포인트를 설정합니다. 포인트 사용을 하지 않는 경우에는 의미가 없습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_settle_point_unit" name="de_settle_point_unit">
                                                    ...
                                                    <option value="10" <?php echo get_selected($default['de_settle_point_unit'], 10); ?>>
                                                        10
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_settle_point_unit'], 1); ?>>
                                                        1
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문 결제시 사용되는 포인트의
                                                절사 단위를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select id="de_card_point" name="de_card_point">
                                                    <option value="0" <?php echo get_selected($default['de_card_point'], 0); ?>>
                                                        아니오
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_card_point'], 1); ?>>
                                                        예
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 신용카드, 계좌이체, 휴대폰
                                                결제시 포인트를 부여할지를 설정합니다. (기본값은 '아니오')
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문완료 후 지정한 일자 이후에
                                                주문자가 회원일 경우에만 포인트를 지급합니다. 주문취소, 반품 등을 고려하여 포인트를 지급할 적당한 기간을 입력하십시오.
                                                (기본값은 7일)<br>0일로 설정하는 경우에는 주문완료와 동시에 포인트를 지급합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="inline-group">
                                                <label for="de_escrow_use1" class="radio"><input type="radio" name="de_escrow_use" value="0" <?php echo $default['de_escrow_use'] == 0 ? "checked" : ""; ?> id="de_escrow_use1"><i></i>
                                                    일반결제 사용</label>
                                                <label for="de_escrow_use2" class="radio"><input type="radio" name="de_escrow_use" value="1" <?php echo $default['de_escrow_use'] == 1 ? "checked" : ""; ?> id="de_escrow_use2"><i></i>
                                                    에스크로결제 사용</label>
                                            </div>

                                            <div class="note margin-bottom-10"><strong>Note:</strong> 에스크로 결제를
                                                사용하시려면,
                                                반드시 결제대행사 상점 관리자 페이지에서 에스크로 서비스를 신청하신 후 사용하셔야 합니다.<br>에스크로 사용시 배송과의
                                                연동은
                                                되지 않으며 에스크로 결제만 지원됩니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="de_tax_flag_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_tax_flag_use" value="1" id="de_tax_flag_use"<?php echo $default['de_tax_flag_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 복합과세(과세, 비과세)
                                                결제를
                                                사용하려면 체크하십시오.<br>복합과세 결제를 사용하기 전 PG사에 별도로 결제 신청을 해주셔야 합니다. 사용시 PG사로
                                                문의하여
                                                주시기 바랍니다.
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-md" role="group" data-toggle="buttons">
                                                <?php /**@type array $PaymentGatewayProvider */
                                                foreach ($PaymentGatewayProvider as $domain => $title): ?>
                                                    <label class="btn btn-default btn-tab-toggle"><input type="radio" name="de_pg_service" id="de_pg_service_<?= $domain ?>" value="<?= $domain ?>" autocomplete="off" /><?= $title ?>
                                                    </label>
                                                <?php endforeach; ?>
                                            </div>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 쇼핑몰에서 사용할 결제대행사를
                                                선택합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="inline-group d-flex">
                                                <label for="de_card_test1" class="radio"><input type="radio" name="de_card_test" value="0" <?php echo $default['de_card_test'] == 0 ? "checked" : ""; ?> id="de_card_test1"><i></i>
                                                    실결제</label>
                                                <label for="de_card_test2" class="radio"><input type="radio" name="de_card_test" value="1" <?php echo $default['de_card_test'] == 1 ? "checked" : ""; ?> id="de_card_test2"><i></i>
                                                    테스트결제</label>
                                                <div class="clearfix"></div>

                                                <div class="pg-note scf_cardtest kcp_cardtest" data-provider="kcp">
                                                    <a href="http://admin.kcp.co.kr/" target="_blank" class="btn-e btn-e-md btn-e-dark">실결제
                                                        관리자</a>
                                                    <a href="http://testadmin8.kcp.co.kr/" target="_blank" class="btn-e btn-e-md btn-e-dark">테스트
                                                        관리자</a>
                                                </div>

                                                <div class="pg-note scf_cardtest lg_cardtest" data-provider="lg">
                                                    <a href="https://pgweb.uplus.co.kr/" target="_blank" class="btn-e btn-e-md btn-e-dark">실결제
                                                        관리자</a>
                                                    <a href="https://pgweb.uplus.co.kr/tmert" target="_blank" class="btn-e btn-e-md btn-e-dark">테스트
                                                        관리자</a>
                                                </div>

                                                <div class="pg-note scf_cardtest inicis_cardtest" data-provider="inicis">
                                                    <a href="https://iniweb.inicis.com/" target="_blank" class="btn-e btn-e-md btn-e-dark">상점
                                                        관리자</a>
                                                </div>

                                                <div class="pg-note scf_cardtest payup_cardtest" data-provider="payup">
                                                    <a href="https://cp.payup.co.kr" target="_blank" class="btn-e btn-e-md btn-e-dark">상점
                                                        관리자</a>
                                                </div>

                                                <div>
                                                    <button type="button" class="scf_cardtest_btn btn-e btn-e-md btn-e-yellow <?php if (G5_IS_MOBILE) { ?>btn-e-block margin-top-5<?php } ?>">테스트결제 팁 더보기</button>
                                                </div>
                                            </div>

                                            <div id="scf_cardtest_tip" class="scf_cardtest_tip_adm_hide">
                                                <strong>일반결제 사용시 테스트 결제</strong>
                                                <dl>
                                                    <dt>신용카드</dt>
                                                    <dd>1000원 이상, 모든 카드가 테스트 되는 것은 아니므로 여러가지 카드로 결제해 보셔야 합니다.<br>(BC,
                                                        현대, 롯데, 삼성카드)
                                                    </dd>
                                                    <dt>계좌이체</dt>
                                                    <dd>150원 이상, 계좌번호, 비밀번호는 가짜로 입력해도 되며, 주민등록번호는 공인인증서의 것과 일치해야
                                                        합니다.
                                                    </dd>
                                                    <dt>가상계좌</dt>
                                                    <dd>1원 이상, 모든 은행이 테스트 되는 것은 아니며 "해당 은행 계좌 없음" 자주 발생함.<br>(광주은행,
                                                        하나은행)
                                                    </dd>
                                                    <dt>휴대폰</dt>
                                                ...
                                                <ul class="pg-note scf_cardtest_tip_adm scf_cardtest_tip_adm_hide" data-provider="kcp">
                                                    <li>테스트결제의
                                                        <a href="http://testadmin8.kcp.co.kr/assist/login.LoginAction.do" target="_blank">상점관리자</a>
                                                        로그인 정보는 NHN KCP로 문의하시기 바랍니다. (기술지원 1544-8661)
                                                    </li>
                                                    <li><b>일반결제</b>의 테스트 사이트코드는 <b>T0000</b> 이며, <b>에스크로 결제</b>의 테스트
                                                        사이트코드는 <b>T0007</b> 입니다.
                                                    </li>
                                                </ul>

                                                <ul class="pg-note scf_cardtest_tip_adm scf_cardtest_tip_adm_hide" data-provider="lg">
                                                    <li>테스트결제의
                                                        <a href="http://pgweb.dacom.net:7085/" target="_blank">상점관리자</a>
                                                        로그인 정보는 토스페이먼츠 상점아이디 첫 글자에 t를 추가해서 로그인하시기 바랍니다. 예)
                                                        tsi_lguplus
                                                    </li>
                                                </ul>

                                                <ul class="pg-note scf_cardtest_tip_adm scf_cardtest_tip_adm_hide" data-provider="inicis">
                                                    <li><b>일반결제</b>의 테스트 사이트 mid는 <b>INIpayTest</b> 이며, <b>에스크로
                                                            결제</b>의
                                                        테스트 사이트 mid는 <b>iniescrow0</b> 입니다.
                                                    </li>
                                                </ul>
                                ...
                                <!-- {* KCP 결제 설정 *} -->
                                <table class="table pg-provider" data-provider="kcp">
                                    <thead>
                                    <tr>
                                        <td colspan="2" class="tbl-title">KCP 결제 설정</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr class="pg_info_fld" id="kcp_info_anchor">
                                        <th class="table-form-th">
                                            <label for="de_kcp_mid" class="label">KCP SITE CODE</label>
                                            <?php if (!G5_IS_MOBILE) { ?>
                                                <a href="http://sir.kr/main/service/p_pg.php" target="_blank" id="scf_kcpreg" class="btn-e btn-e-md btn-e-dark btn-e-block">NHN
                                                    KCP 신청하기</a>
                                            <?php } ?>
                                        </th>
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> NHN KCP 에서 받은
                                                SR 로
                                                시작하는 영대문자, 숫자 혼용 총 5자리 중 SR 을 제외한 나머지 3자리 SITE CODE 를 입력하세요.<br>만약,
                                                사이트코드가 SR로 시작하지 않는다면 NHN KCP에 사이트코드 변경 요청을 하십시오. 예) SR9A3
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 25자리 영대소문자와 숫자
                                                -
                                                그리고 _ 로 이루어 집니다. SITE KEY 발급 NHN KCP 전화: 1544-8660<br>예)
                                    ...
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            <label class="checkbox" for="de_easy_nhnkcp_payco" disabled><input type="checkbox" id="de_easy_nhnkcp_payco" name="de_easy_pays[]" value="nhnkcp_payco" <?php if (stripos($default['de_easy_pay_services'], 'nhnkcp_payco') !== false) {
                                                    echo 'checked="checked"';
                                                } ?> ><i></i> PAYCO (페이코)</label>
                                            <label class="checkbox" for="de_easy_nhnkcp_naverpay"><input type="checkbox" id="de_easy_nhnkcp_naverpay" name="de_easy_pays[]" value="nhnkcp_naverpay" <?php if (stripos($default['de_easy_pay_services'], 'nhnkcp_naverpay') !== false) {
                                                    echo 'checked="checked"';
                                                } ?> ><i></i> NAVERPAY (네이버페이)</label>
                                            <label class="checkbox" for="de_easy_nhnkcp_kakaopay"><input type="checkbox" id="de_easy_nhnkcp_kakaopay" name="de_easy_pays[]" value="nhnkcp_kakaopay" <?php if (stripos($default['de_easy_pay_services'], 'nhnkcp_kakaopay') !== false) {
                                                    echo 'checked="checked"';
                                                } ?> ><i></i> KAKAOPAY (카카오페이)</label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 체크시 NHN KCP
                                                간편결제들을
                                                활성화 합니다.<br>NHN_KCP > 네이버페이, 카카오페이는 테스트결제가 되지 않습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_global_nhnkcp_naverpay" class="label">NHN KCP 네이버페이
                                                사용</label>
                                        </th>
                                        <td>
                                            <label class="checkbox" for="de_global_nhnkcp_naverpay" disabled><input type="checkbox" id="de_global_nhnkcp_naverpay" name="de_easy_pays[]" value="global_nhnkcp_naverpay" <?php if (stripos($default['de_easy_pay_services'], 'global_nhnkcp_naverpay') !== false) {
                                                    echo 'checked="checked"';
                                                } ?> ><i></i> NAVERPAY (네이버페이)</label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 체크시 타 PG
                                                (토스페이먼츠,
                                                KG 이니시스) 사용중일때도 NHN_KCP 를 통한 네이버페이 간편결제를 사용할수 있습니다.<br>실결제시 반드시
                                                결제대행사
                                                NHN_KCP 항목에 KCP SITE CODE와 NHN KCP SITE KEY를 입력해야 합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="used_nhnkcp_naverpay_point" class="label">NHN KCP 네이버페이<br>포인트결제
                                                사용</label>
                                        </th>
                                        <td>
                                            <label class="checkbox" for="used_nhnkcp_naverpay_point" disabled><input type="checkbox" id="used_nhnkcp_naverpay_point" name="de_easy_pays[]" value="used_nhnkcp_naverpay_point" <?php if (stripos($default['de_easy_pay_services'], 'used_nhnkcp_naverpay_point') !== false) {
                                                    echo 'checked="checked"';
                                                } ?> ><i></i> NAVERPAY POINT (네이버페이 포인트 사용)</label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong>
                                                체크시 NHN_KCP를 통한 네이버페이 결제시 네이버페이 포인트결제가 활성화 됩니다.<br>
                                                체크를 했는데도 [DR02] 실결제시 가맹점 설정정보가 올바르지 않습니다 라고 메시지가 뜬다면,
                                                체크를 해제하고 NHN_KCP 에 위에서 설정한 KCP SITE CODE 로 네이버페이 포인트 결제가 가능한지 문의해 주세요.
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                                ...
                                <!-- {* 토스 결제 설정 *} -->
                                <table class="table pg-provider" data-provider="lg">
                                    <thead>
                                    <tr>
                                        <td colspan="2" class="tbl-title">토스페이먼츠 결제 설정</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr class="pg_info_fld" id="lg_info_anchor">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 토스페이먼츠에서 받은
                                                si_ 로
                                                시작하는 상점 ID를 입력하세요.<br>만약, 상점 ID가 si_로 시작하지 않는다면 토스페이먼츠에 사이트코드 변경 요청을
                                                하십시오. 예)
                                                si_lguplus<br><a href="<?php echo G5_ADMIN_URL; ?>/config_form.php#anc_cf_cert">기본환경설정
                                                    &gt; 본인확인</a> 설정의 토스페이먼츠 상점아이디와 동일합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 토스페이먼츠
                                                상점MertKey는
                                                상점관리자 -> 계약정보 -> 상점정보관리에서 확인하실 수 있습니다.<br>예)
                                                95160cce09854ef44d2edb2bfb05f9f3<br><a href="<?php echo G5_ADMIN_URL; ?>/config_form.php#anc_cf_cert">기본환경설정
                                                    &gt; 본인확인</a> 설정의 토스페이먼츠 MERT KEY와 동일합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
                                ...
                                <!-- {* 이니시스 결제 설정 *} -->
                                <table class="table pg-provider" data-provider="inicis">
                                    <thead>
                                    <tr>
                                        <td colspan="2" class="tbl-title">KG이니시스 결제 설정</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr class="pg_info_fld" id="inicis_info_anchor">
                                        <th class="table-form-th">
                                            ...
                                            <?php if (!G5_IS_MOBILE) { ?>
                                                <a href="http://sir.kr/main/service/inicis_pg.php" target="_blank" id="scf_kgreg" class="btn-e btn-e-md btn-e-dark btn-e-block">KG이니시스
                                                    신청하기</a>
                                            <?php } ?>
                                        </th>
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스로 부터 발급
                                                받으신
                                                상점아이디(MID) 10자리 중 SIR 을 제외한 나머지 7자리를 입력 합니다.<br>만약, 상점아이디가 SIR로 시작하지
                                                않는다면 계약담당자에게 변경 요청을 해주시기 바랍니다. (Tel. 02-3430-5858) 예) SIRpaytest
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스에서 발급받은
                                                4자리
                                                상점 키패스워드를 입력합니다.<br>KG이니시스 상점관리자 패스워드와 관련이 없습니다.<br>키패스워드 값을 확인하시려면
                                                상점측에
                                                발급된 키파일 안의 readme.txt 파일을 참조해 주십시오.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스에서 발급받은
                                                웹결제
                                                사인키를 입력합니다.\nKG이니시스 상점관리자 > 상점정보 > 계약정보 > 부가정보의 웹결제 signkey생성 조회 버튼
                                                클릭,
                                    ...
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            ...
                                            <?php if (!G5_IS_MOBILE) { ?>
                                                <a href="http://sir.kr/main/service/samsungpay.php" target="_blank" id="scf_kgreg" class="btn-e btn-e-md btn-e-dark btn-e-block">삼성페이
                                                    서비스 신청하기</a>
                                            <?php } ?>
                                        </th>
                                        <td>
                                            <label for="de_samsung_pay_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_samsung_pay_use" value="1" id="de_samsung_pay_use"<?php echo $default['de_samsung_pay_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스와 별도로
                                                <strong>삼성페이 사용 계약을 하신 경우</strong>에만 체크해주세요. (모바일 주문서 결제수단에 삼성페이가
                                                노출됩니다.) <br>실결제시 반드시 결제대행사 KG이니시스 항목에 상점 아이디와 키패스워드를 입력해 주세요.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        ...
                                        <td>
                                            <label for="de_inicis_lpay_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_inicis_lpay_use" value="1" id="de_inicis_lpay_use"<?php echo $default['de_inicis_lpay_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 체크시 KG이니시스
                                                L.pay를
                                                사용합니다. <br>실결제시 반드시 결제대행사 KG이니시스 항목의 상점 정보( 아이디, 키패스워드, 웹결제 사인키 )를
                                                입력해
                                                주세요.
                                            </div>
                                        </td>
                                    ...
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_inicis_kakaopay_use" class="label">KG이니시스 카카오페이
                                                사용</label>
                                        </th>
                                        <td>
                                            <label for="de_inicis_kakaopay_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_inicis_kakaopay_use" value="1" id="de_inicis_kakaopay_use"<?php echo $default['de_inicis_kakaopay_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 체크시 KG이니시스 결제의
                                                카카오페이를 사용합니다. 주문서 결제수단에 카카오페이가 노출됩니다. <br>실결제시 반드시 결제대행사 KG이니시스 항목의
                                                상점
                                                정보( 아이디, 키패스워드, 웹결제 사인키 )를 입력해 주세요.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_inicis_cartpoint_use" class="label">KG이니시스 신용카드 포인트
                                                결제</label>
                                        </th>
                                        <td>
                                            <label for="de_inicis_cartpoint_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_inicis_cartpoint_use" value="1" id="de_inicis_cartpoint_use"<?php echo $default['de_inicis_cartpoint_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 신용카드 포인트 결제에
                                                대해
                                                이니시스와 계약을 맺은 상점에서만 적용하는 옵션입니다.<br>체크시 pc 결제에서는 신용카드 포인트 사용 여부에 대한
                                                팝업창에
                                                사용 버튼과 사용안함 버튼이 표기되어 결제하는 고객의 선택여부에 따라 신용카드 포인트 결제가 가능합니다.<br>모바일에서는
                                                신용카드 포인트 사용이 가능합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="kakao_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_kakaopay_mid" class="label">카카오페이 상점아이디<br>( KG이니시스
                                                )</label>
                                            <?php if (!G5_IS_MOBILE) { ?>
                                                <a href="http://sir.kr/main/service/kakaopay.php?kk=yc5" target="_blank" class="btn-e btn-e-md btn-e-yellow btn-e-block">카카오페이
                                                    서비스신청하기</a>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> KG이니시스로 부터
                                                카카오페이
                                                간편결제만 사용용도로 발급 받으신 상점아이디(MID) 10자리 중 SIRK 을 제외한 나머지 6자리를 입력 합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="kakao_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_kakaopay_key" class="label">카카오페이 상점키<br>( KG이니시스
                                                )</label>
                                        </th>
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> SIRK******
                                                아이디로
                                                KG이니시스에서 발급받은 웹결제 사인키를 입력합니다.\nKG이니시스 상점관리자 > 상점정보 > 계약정보 > 부가정보의
                                                웹결제
                                                signkey생성 조회 버튼 클릭, 팝업창에서 생성 버튼 클릭 후 해당 값을 입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="kakao_info_fld">
                                        <th class="table-form-th">
                                            <label for="de_kakaopay_enckey" class="label">카카오페이 키패스워드<br>( KG이니시스
                                                )</label>
                                        </th>
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> SIRK******
                                                아이디로
                                                KG이니시스에서 발급받은 4자리 상점 키패스워드를 입력합니다.\nKG이니시스 상점관리자 패스워드와 관련이
                                                없습니다.\n키패스워드
                                    ...
                                    <tr class="kakao_info_fld">
                                        ...
                                        <td>
                                            <label for="de_kakaopay_enckey" class="checkbox">
                                                <input type="checkbox" name="de_kakaopay_enckey" value="1" id="de_kakaopay_enckey" <?php echo $default['de_kakaopay_enckey'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 체크시 카카오페이 (KG
                                                이니시스)를 사용합니다. <br>KG 이니시스의 SIRK****** 아이디를 받은 상점만 해당됩니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="kakao_info_fld" style="display:none">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 카카오페이로 부터 발급
                                                받으신
                                                상점 인증 전용 HashKey를 입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="naver_info_fld">
                                        <th class="table-form-th">
                                            ...
                                            <?php if (!G5_IS_MOBILE) { ?>
                                                <a href="http://sir.kr/main/service/naverpay.php" target="_blank" class="btn-e btn-e-md btn-e-green btn-e-block">네이버페이
                                                    서비스신청하기</a>
                                            <?php } ?>
                                        </th>
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이 가맹점 아이디를
                                                입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="naver_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이 가맹점 인증키를
                                                입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label for="de_naverpay_test" class="select form-width-250px">
                                                <select id="de_naverpay_test" name="de_naverpay_test">
                                                    <option value="1" <?php echo get_selected($default['de_naverpay_test'], 1); ?>>
                                                        예
                                                    </option>
                                                    <option value="0" <?php echo get_selected($default['de_naverpay_test'], 0); ?>>
                                                        아니오
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이 결제테스트
                                                여부를
                                                설정합니다. 검수 과정 중에는 <strong>예</strong>로 설정해야 하며 최종 승인 후
                                                <strong>아니오</strong>로 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="naver_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이 결제테스트를
                                                위한
                                                테스트 회원 아이디를 입력합니다. 네이버페이 검수 과정에서 필요합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <?php if (!G5_IS_MOBILE) { ?>
                                        <tr class="naver_info_fld">
                                            ...
                                            <td>
                                                ...
                                                <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이에
                                                    상품정보를
                                                    XML 데이터로 제공하는 페이지입니다. 검수과정에서 아래의 URL 정보를 제공해야 합니다.
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    <tr class="naver_info_fld">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 네이버페이를 통한 결제 때
                                                구매자에게 보여질 추가배송비 내용을 입력합니다.<br>예) 제주도 3,000원 추가, 제주도 외 도서·산간 지역
                                                5,000원 추가
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <!-- {* 페이업 결제 설정 *} -->
                                <table class="table pg-provider" data-provider="payup">
                                    <thead>
                                    <tr>
                                        <td colspan="2" class="tbl-title">페이업 결제 설정</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="cf_payup_mid" class="label">페이업 상점아이디</label>
                                        </th>
                                        <td>
                                            <label class="input form-width-250px">
                                                <input type="text" name="de_payup_mid" value="<?php echo $default['de_payup_mid']; ?>" id="cf_payup_mid">
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 페이업에서 받은 상점 ID를 입력하세요.</div>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="cf_payup_secret" class="label">페이업 인증키</label>
                                        </th>
                                        <td>
                                            <label class="input form-width-250px">
                                                <input type="text" name="de_payup_secret" value="<?php echo $default['de_payup_secret']; ?>" id="cf_payup_secret">
                                            </label>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="cf_payup_mid2" class="label">가상계좌 아이디</label>
                                        </th>
                                        <td>
                                            <label class="input form-width-250px">
                                                <input type="text" name="de_payup_mid2" value="<?php echo $default['de_payup_mid2']; ?>" id="cf_payup_mid2">
                                            </label>
                                        </td>
                                    </tr>
                                    <tr class="pg_info_fld">
                                        <th class="table-form-th">
                                            <label for="cf_payup_secret2" class="label">가상계좌 인증키</label>
                                        </th>
                                        <td>
                                            <label class="input form-width-250px">
                                                <input type="text" name="de_payup_secret2" value="<?php echo $default['de_payup_secret2']; ?>" id="cf_payup_secret2">
                                            </label>
                                        </td>
                                    </tr>
                                    </tbody>
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 이용 중이거나 이용하실 배송업체를
                                                선택하세요.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select name="de_send_cost_case" id="de_send_cost_case">
                                                    ...
                                                    <option value="무료" <?php echo get_selected($default['de_send_cost_case'], "무료"); ?>>
                                                        무료배송
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong>
                                                <strong>금액별차등</strong>으로 설정한 경우, 주문총액이 배송비상한가 미만일 경우 배송비를
                                                받습니다.<br><strong>무료배송</strong>으로 설정한 경우, 배송비상한가 및 배송비를 무시하며 착불의 경우도
                                                무료배송으로 설정합니다.<br><strong>상품별로 배송비 설정을 한 경우 상품별 배송비 설정이 우선</strong>
                                                적용됩니다.<br>예를 들어 무료배송으로 설정했을 때 특정 상품에 배송비가 설정되어 있으면 주문시 배송비가 부과됩니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 배송비유형이 '금액별차등'일
                                                경우에만 해당되며 배송비상한가를 여러개 두고자 하는 경우는 <b>;</b> 로 구분합니다.<br>예를 들어 20000원 미만일
                                                경우 4000원, 30000원 미만일 경우 3000원 으로 사용할 경우에는 배송비상한가를 20000;30000 으로 입력하고
                                                배송비를 4000;3000 으로 입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label class="select form-width-250px">
                                                <select name="de_hope_date_use" id="de_hope_date_use">
                                                    <option value="0" <?php echo get_selected($default['de_hope_date_use'], 0); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_hope_date_use'], 1); ?>>
                                                        사용
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> '예'로 설정한 경우 주문서에서
                                                희망배송일을 입력 받습니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 오늘을 포함하여 설정한 날
                                                이후부터 일주일 동안을 달력 형식으로 노출하여 선택할수 있도록 합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table">
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col col-2">
                                                    ...
                                                    <label class="checkbox">
                                                        <input type="checkbox" name="de_rel_list_use" value="1" id="de_rel_list_use" <?php echo $default['de_rel_list_use'] ? "checked" : ""; ?>><i></i>
                                                        출력
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 관련상품의 경우 등록된 상품은
                                                모두 출력하므로 '출력할 줄 수'는 설정하지 않습니다. 이미지높이를 0으로 설정하면 상품이미지를 이미지폭에 비례하여 생성합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col col-2">
                                                    ...
                                                    <label class="checkbox">
                                                        <input type="checkbox" name="de_mobile_rel_list_use" value="1" id="de_mobile_rel_list_use" <?php echo $default['de_mobile_rel_list_use'] ? "checked" : ""; ?>><i></i>
                                                        출력
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_search_img_height" class="label">이미지
                                                        높이</label>
                                                    <label class="input">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_search_list_mod" class="label">1줄당 이미지
                                                        수</label>
                                                    <label class="input">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_listtype_img_width" class="label">이미지
                                                        폭</label>
                                                    <label class="input">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_listtype_img_height" class="label">이미지
                                                        높이</label>
                                                    <label class="input">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_listtype_list_mod" class="label">1줄당 이미지
                                                        수</label>
                                                    <label class="input">
                                                ...
                                                <div class="col col-2">
                                                    <label for="de_mobile_listtype_list_row" class="label">출력할 줄
                                                        수</label>
                                                    <label class="input">
                                    ...
                                    <span>
                                        ...
                                        <label for="de_simg_height" class="input form-width-200px">
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 분류리스트에서 보여지는 사이즈를
                                                설정하시면 됩니다. 분류관리의 출력 이미지폭, 높이의 기본값으로 사용됩니다. 높이를 0 으로 설정하시면 폭에 비례하여 높이를
                                                썸네일로 생성합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <span>
                                        ...
                                        <label for="de_mimg_height" class="input form-width-200px">
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 상품상세보기에서 보여지는
                                                상품이미지의 사이즈를 픽셀로 설정합니다. 높이를 0 으로 설정하시면 폭에 비례하여 높이를 썸네일로 생성합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="de_item_use_write" class="select form-width-250px">
                                                <select name="de_item_use_write" id="de_item_use_write">
                                                    <option value="0" <?php echo get_selected($default['de_item_use_write'], 0); ?>>
                                                        주문상태와 무관하게 작성가능
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_item_use_write'], 1); ?>>
                                                        주문상태가 완료인 경우에만 작성가능
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문상태에 따른 사용후기
                                                작성여부를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label for="de_item_use_use" class="select form-width-250px">
                                                <select name="de_item_use_use" id="de_item_use_use">
                                                    <option value="0" <?php echo get_selected($default['de_item_use_use'], 0); ?>>
                                                        즉시 출력
                                                    </option>
                                                    <option value="1" <?php echo get_selected($default['de_item_use_use'], 1); ?>>
                                                        관리자 승인 후 출력
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 사용후기가 올라오면, 즉시 출력
                                                혹은 관리자 승인 후 출력 여부를 설정합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 권한을 1로 설정하면 누구나
                                                구입할 수 있습니다. 특정회원만 구입할 수 있도록 하려면 해당 권한으로 설정하십시오.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="de_code_dup_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_code_dup_use" value="1" id="de_code_dup_use"<?php echo $default['de_code_dup_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 분류, 상품 등을 추가할 때
                                                자동으로 코드 중복검사를 하려면 체크하십시오.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 장바구니 상품의 보관 기간을
                                                설정하십시오.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <label for="de_guest_cart_use" class="checkbox form-width-100px">
                                                <input type="checkbox" name="de_guest_cart_use" value="1" id="de_guest_cart_use"<?php echo $default['de_guest_cart_use'] ? ' checked' : ''; ?>><i></i>
                                                사용
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 비회원 장바구니 기능을 사용하려면
                                                체크하십시오.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col col-3">
                                                    ...
                                                    <label class="checkbox">
                                                        <input type="checkbox" name="de_member_reg_coupon_use" value="1" id="de_member_reg_coupon_use" <?php echo $default['de_member_reg_coupon_use'] ? ' checked' : ''; ?>><i></i>
                                                        사용
                                                    </label>
                ...
                <div id="anc_scf_sms">
                    ...
                    <div class="adm-table-form-wrap margin-bottom-30">
                                ...
                                <table class="table">
                                        ...
                                        <td>
                                            <label for="cf_sms_use" class="select form-width-250px">
                                                <select id="cf_sms_use" name="cf_sms_use">
                                                    <option value="" <?php echo get_selected($config['cf_sms_use'], ''); ?>>
                                                        사용안함
                                                    </option>
                                                    <option value="icode" <?php echo get_selected($config['cf_sms_use'], 'icode'); ?>>
                                                        아이코드
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> SMS 서비스 회사를
                                                선택하십시오. 서비스 회사를 선택하지 않으면, SMS 발송 기능이 동작하지 않습니다.<br>아이코드는 무료 문자메세지 발송 테스트
                                                환경을
                                                지원합니다.<br><a href="<?php echo G5_ADMIN_URL; ?>/?dir=config&amp;pid=config_form#anc_cf_sms">기본환경설정
                                                    &gt; SMS</a> 설정과 동일합니다.
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <label for="cf_sms_type" class="select form-width-250px">
                                                <select id="cf_sms_type" name="cf_sms_type">
                                                    <option value="" <?php echo get_selected($config['cf_sms_type'], ''); ?>>
                                                        SMS
                                                    </option>
                                                    <option value="LMS" <?php echo get_selected($config['cf_sms_type'], 'LMS'); ?>>
                                                        LMS
                                                    </option>
                                                </select><i></i>
                                            </label>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 전송유형을 SMS로 선택하시면
                                                최대 80바이트까지 전송하실 수 있으며<br>LMS로 선택하시면 90바이트 이하는 SMS로, 그 이상은 1500바이트까지 LMS로
                                                전송됩니다.<br>요금은 건당 SMS는 16원, LMS는 48원입니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 주문서작성시 쇼핑몰관리자가
                                                문자메세지를 받아볼 번호를 숫자만으로 입력하세요. 예) 0101234567
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="icode_old_version">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 아이코드에서 사용하시는
                                                회원아이디를 입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="icode_old_version">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 아이코드에서 사용하시는 비밀번호를
                                                입력합니다.
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="icode_json_version">
                                        ...
                                        <td>
                                            ...
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 아이코드 JSON 버전의 경우
                                                아이코드 토큰키를 입력시 실행됩니다.<br>SMS 전송유형을 LMS로 설정시 90바이트 이내는 SMS, 90 ~ 2000 바이트는
                                                LMS 그 이상은 절삭 되어 LMS로 발송됩니다.
                                            </div>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 아이코드 사이트 -> 토큰키관리
                                                메뉴에서 생성한 토큰키를 입력합니다.
                                            </div>
                                            <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="http://icodekorea.com/res/join_company_fix_a.php?sellid=sir2" target="_blank" class="btn-e btn-e-sm btn-e-dark text-center">아이코드
                                                회원가입</a>
                                            <div class="note margin-bottom-10"><strong>Note:</strong> 아래 링크에서 회원가입 하시면
                                                문자 건당 16원에 제공 받을 수 있습니다.
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <?php } ?>
                            ...
                            <header class="border-bottom-1px"><strong><i class="fas fa-caret-right"></i> 사전에 정의된 SMS프리셋</strong>
                            </header>
                            ...
                            <div id="scf_sms">
                                <?php
                                $scf_sms_title = [1 => "회원가입시 고객님께 발송", "주문시 고객님께 발송", "주문시 관리자에게 발송", "입금확인시 고객님께 발송", "상품배송시 고객님께 발송"];
                                for ($i = 1; $i <= 5; $i++) {
                                    ?>
                                    <section class="scf_sms_box">
                                        ...
                                        <label for="de_sms_use<?php echo $i; ?>" class="checkbox" style="margin-left:50px;width:30px;">
                                            <input type="checkbox" name="de_sms_use<?php echo $i; ?>" value="1" id="de_sms_use<?php echo $i; ?>" <?php echo($default["de_sms_use" . $i] ? " checked" : ""); ?>><i></i>
                                            사용 <span class="sound_only"><?php echo $scf_sms_title[$i]; ?></span>
                                        </label>
    ...
    <script type="text/javascript" src="<?php echo EYOOM_ADMIN_THEME_URL; ?>/plugins/eyoom-form/plugins/jquery-maskedinput/jquery.maskedinput.min.js"></script>
    <script type="text/javascript">


        $(function () {
            $(document).ready(function () {
                $("#de_global_nhnkcp_naverpay").on("click", function () {
                    $(this).prop('checked') && $("#de_easy_nhnkcp_naverpay").prop('checked', true);
                });
                ...
                $(document).on("click", ".pg_test_conf_link", function (e) {
                    e.preventDefault();
                    var str_hash;
                    (str_hash = this.href.split("#")[1]) && hash_goto_scroll(str_hash);
                });
            });
            ...
            var form = $('form[name="fconfig"]'), provide = form.find('INPUT:radio[name="de_pg_service"]');
            form.submit(function (event) {
                ...
                var notify, provider_name;

                if (this.de_pg_service.value == "kcp" && this.de_kcp_mid.value && this.de_kcp_site_key.value && parseInt(this.de_card_test.value) > 0) {
                    provider_name = "NHN KCP";
                }
                else if (this.de_pg_service.value == "lg" && this.cf_lg_mid.value && this.cf_lg_mert_key.value && parseInt(this.de_card_test.value) > 0) {
                    provider_name = "토스페이먼츠";

                }
                else if (this.de_pg_service.value == "inicis" && this.de_inicis_mid.value && this.de_inicis_sign_key.value && parseInt(this.de_card_test.value) > 0) {
                    provider_name = "KG이니시스";
                }
                else if (this.de_pg_service.value == "payup" && this.de_payup_mid.value && this.de_payup_secret.value && parseInt(this.de_card_test.value) > 0) {
                    provider_name = "페이업";
                }
                provider_name && (notify = "(주의!) " + provider_name + " 결제의 결제 설정이 현재 테스트결제 로 되어 있습니다.\n쇼핑몰 운영중이면 반드시 실결제로 설정하여 운영하셔야 합니다.\n실결제로 변경하려면 결제설정 탭 -> 결제 테스트에서 실결제를 선택해 주세요.\n정말로 테스트결제로 설정하시겠습니까?");
                if (notify && confirm(notify) === false) {
                    return false;
                }
                this.submit();
            })
                .find('INPUT:radio[name="de_pg_service"]').on('change', function (event) {
                var service = provide.filter(':checked').val();
                $('.pg-provider, .pg-note, .pg_vbank_url').hide().filter('[data-provider="' + service + '"]').show();
            }).filter('[value="<?=$default['de_pg_service']?>"]').click();

            $(".scf_cardtest_btn").on("click", function () {
            ...
            $(document).on("change", "#de_taxsave_use", function (e) {
                var $val = $(this).val();
                parseInt($val) > 0 ? $("#de_taxsave_types").show() : $("#de_taxsave_types").hide()
            });
