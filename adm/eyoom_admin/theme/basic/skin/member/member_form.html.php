...
?>
                ...
                <div class="table-list-eb">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <th class="table-form-th">
                                    <label for="mb_email" class="label">대리점<strong class="sound_only">필수</strong></label>
                                </th>
                                <td colspan="3">
                                    <div class="row">
                                        <section class="col col-5 margin-0">
                                            <label class="input">
                                                <?php if (empty($mb['agent']) === true) { ?>
                                                    <i class="icon-prepend fas fa-map-marked-alt"></i>
                                                    <span class="frm-control"><i class="color-orange">미등록</i></span>
                                                <?php } else { ?>
                                                    <i class="icon-prepend fas fa-map-marked-alt"></i>
                                                    <span class="frm-control"><?= implode(' ', $mb['agent']); ?></span>
                                                <?php } ?>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="inline-group">
                                        <label for="mb_certify_ipin" class="radio"><input type="radio" name="mb_certify_case" value="ipin" id="mb_certify_ipin" <?php if ($mb['mb_certify_case'] == 'ipin') echo 'checked="checked"'; ?>><i></i>
                                            아이핀</label>
                                        <label for="mb_certify_hp" class="radio"><input type="radio" name="mb_certify_case" value="hp" id="mb_certify_hp" <?php if ($mb['mb_certify_case'] == 'hp') echo 'checked="checked"'; ?>><i></i>
                                            휴대폰</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="inline-group">
                                        <label for="mb_certify_yes" class="radio"><input type="radio" name="mb_certify" value="1" id="mb_certify_yes" <?php echo $mb_certify_yes; ?>><i></i>
                                            예</label>
                                        <label for="mb_certify_no" class="radio"><input type="radio" name="mb_certify" value="0" id="mb_certify_no" <?php echo $mb_certify_no; ?>><i></i>
                                            아니오</label>

                                        <button type="button" class="btn-e btn-e-sm btn-e-dark certify-reset"<?=$mb['mb_certify'] && $mb['mb_dupinfo'] ? '': ' disabled'?>>본인인증 초기화</button>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="inline-group">
                                        <label for="mb_adult_yes" class="radio"><input type="radio" name="mb_adult" value="1" id="mb_adult_yes" <?php echo $mb_adult_yes; ?>><i></i>
                                            예</label>
                                        <label for="mb_adult_no" class="radio"><input type="radio" name="mb_adult" value="0" id="mb_adult_no" <?php echo $mb_adult_no; ?>><i></i>
                                            아니오</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="row">
                                        ...
                                        <div class="col col-2">
                                            <section>
                                                <button type="button" onclick="win_zip('fmember', 'mb_zip', 'mb_addr1', 'mb_addr2', 'mb_addr3', 'mb_addr_jibeon');" class="btn-e btn-e-purple" style="padding:4px 12px 3px">
                                                    주소 검색
                                                </button>
                                            </section>
                                        </div>
                                ...
                                <td>
                                    <label for="file" class="input input-file">
                                        <div class="button bg-color-light-grey">
                                            <input type="file" id="mb_icon" name="mb_icon" value="파일선택" onchange="this.parentNode.nextSibling.value = this.value">파일선택
                                        </div>
                                        <input type="text" readonly>
                                    </label>
                                    <?php if ($icon_url) { ?>
                                        <img src="<?php echo $icon_url . $icon_filemtile; ?>" alt="">
                                        <label for="del_mb_icon" class="checkbox"><input type="checkbox" id="del_mb_icon" name="del_mb_icon" value="1"><i></i>
                                            삭제</label>
                                    <?php } ?>
                                    <div class="note"><strong>Note:</strong> 아이콘 크기는
                                        <strong>넓이 <?php echo $config['cf_member_icon_width']; ?>픽셀
                                            높이 <?php echo $config['cf_member_icon_height']; ?>픽셀</strong>로 해주세요.
                                    </div>
                                </td>
                                <?php if (G5_IS_MOBILE) { ?>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <label for="file" class="input input-file">
                                        <div class="button bg-color-light-grey">
                                            <input type="file" id="mb_img" name="mb_img" value="파일선택" onchange="this.parentNode.nextSibling.value = this.value">파일선택
                                        </div>
                                        <input type="text" readonly>
                                    </label>
                                    <?php if (file_exists($photo_file)) { ?>
                                        <?php echo get_member_profile_img($mb['mb_id']); ?>
                                        <label for="del_mb_img" class="checkbox"><input type="checkbox" id="del_mb_img" name="del_mb_img" value="1"><i></i>
                                            삭제</label>
                                    <?php } ?>
                                    <div class="note"><strong>Note:</strong> 이미지 크기는
                                        <strong>넓이 <?php echo $config['cf_member_img_width']; ?>픽셀
                                            높이 <?php echo $config['cf_member_img_height']; ?>픽셀</strong>로 해주세요.
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="inline-group">
                                        <label for="mb_mailling_yes" class="radio"><input type="radio" name="mb_mailling" id="mb_mailling_yes" value="1" <?php echo $mb_mailling_yes; ?>><i></i>
                                            예</label>
                                        <label for="mb_mailling_no" class="radio"><input type="radio" name="mb_mailling" id="mb_mailling_no" value="0" <?php echo $mb_mailling_no; ?>><i></i>
                                            아니오</label>
                                    </div>
                                </td>
                                <?php if (G5_IS_MOBILE) { ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="inline-group">
                                        <label for="mb_sms_yes" class="radio"><input type="radio" name="mb_sms" id="mb_sms_yes" value="1" <?php echo $mb_sms_yes; ?>><i></i>
                                            예</label>
                                        <label for="mb_sms_no" class="radio"><input type="radio" name="mb_sms" id="mb_sms_no" value="0" <?php echo $mb_sms_no; ?>><i></i>
                                            아니오</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="inline-group">
                                        <label for="mb_open_yes" class="radio"><input type="radio" name="mb_open" id="mb_open_yes" value="1" <?php echo $mb_open_yes; ?>><i></i>
                                            예</label>
                                        <label for="mb_open_no" class="radio"><input type="radio" name="mb_open" id="mb_open_no" value="0" <?php echo $mb_open_no; ?>><i></i>
                                            아니오</label>
                                    </div>
                                </td>
                            </tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <?php if ($mb['mb_email_certify'] == '0000-00-00 00:00:00') { ?>
                                                <label for="passive_certify" class="checkbox">
                                                    <input type="checkbox" name="passive_certify" id="passive_certify"><i></i>
                                                    수동인증
                                                </label>
                                                <div class="note"><strong>Note:</strong> 회원님이 메일을 수신할 수 없는 경우 등에 직접
                                                    인증처리를 하실 수 있습니다.
                                                </div>
                                            <?php } else { ?>
                                                <label class="input">
    ...
    this.form.mb_leave_date.value=this.value; } else { this.form.mb_leave_date.value=this.form.mb_leave_date.defaultValue; }"><i></i>
                                            탈퇴일을 오늘로 지정
                                        </label>
                                    </div>
                                </td>
    ...
    this.form.mb_intercept_date.value=this.form.mb_intercept_date.defaultValue; }"><i></i> 접근차단일을 오늘로 지정
        ...
        <div class="table-list-eb">
            <?php if (!G5_IS_MOBILE) { ?><div class="table-responsive"><?php } ?>
            <table class="table">
                <tbody>
                    <?php for ($i = 1; $i <= 10; $i++) { ?>
                    <tr>
    ...
    <form name="frmRemoveCertificate" method="post" action="<?php echo $action_url1; ?>">
        <input type="hidden" name="w" value="R">
        <input type="hidden" name="scope" value="removeCertificate">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('button.certify-reset').on('click', function () {
                if (!confirm('인증정보를 초기화하시겠습니까?')) return false;
                var token, $form = $('FORM[name="frmRemoveCertificate"]');

                if (!(token = get_ajax_token())) {
                    alert("토큰 정보가 올바르지 않습니다.");
                    return false;
                }

                $form.find("input[name=token]").val(token);
                $('FORM[name="frmRemoveCertificate"]').submit();
            })
        });
    </script>
