...
*/
$menu["menu900"] = [
    ['900000', 'SMS 관리', G5_SMS5_ADMIN_URL.'/dashboard.php', 'coolsms']
    , ['900100', 'CoolSMS 현황', G5_ADMIN_URL.'/dashboard.php', 'coolsms_summary']    
    , ['900200', 'CoolSMS 전송내역', G5_ADMIN_URL.'/history.php', 'coolsms_history']
    , ['900300', '문자보내기', G5_ADMIN_URL.'/history.php', 'coolsms_write']
];
