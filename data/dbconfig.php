...
if (G5_ENV == 'production') {

    define('G5_MYSQL_HOST', 'arch.barrybarry.market');
    define('G5_MYSQL_USER', 'barry');
    define('G5_MYSQL_PASSWORD', 'db1234');
    define('G5_MYSQL_DB', 'barry');
    define('G5_MYSQL_SET_MODE', true);
}
else if (G5_ENV == 'development') {

    ##define('G5_MYSQL_HOST', 'localhost');
    ##define('G5_MYSQL_USER', 'barryDev');
    ##define('G5_MYSQL_PASSWORD', 'todo#@09');
    define('G5_MYSQL_HOST', 'arch.barrybarry.market');
    define('G5_MYSQL_USER', 'barry');
    define('G5_MYSQL_PASSWORD', 'db1234');
    define('G5_MYSQL_DB', 'barry');
