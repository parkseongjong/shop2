...
($default['de_pg_service'] == 'inicis' || $default['de_inicis_lpay_use'] || $default['de_inicis_kakaopay_use']) && set_session('ss_order_inicis_id', $od_id);
$default['de_pg_service'] == 'payup' && set_session('ss_order_payup_id', $od_id);
