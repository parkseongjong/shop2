...
class theme extends qfile
{
    ...
    public function get_meinfo_link($url) {
        ...
        if ($url['query']) {
            ...
            foreach ($query as $key => $val) {
                if (in_array($key,array('theme', 'shop_theme', 'bo_table', 'gr_id', 'co_id', 'ca_id', 'it_id', 'pid', 'faq', 'fm_id', 'sca', 'sfl', 'tag', 'po_id', 'ev_id', 'tp_id'))) {
                    switch($key) {
                        ...
                        case 'tp_id'        : $info['me_type'] = 'userpage'; break;
    ...
    private function get_default_page() {
        ...
        switch($key) {
            ...
            case 'register_member'  : $title = '회원가입'; $cate_name = '회원가입'; break;;
            case 'register'         : $title = '회원가입'; $cate_name = '회원가입'; break;
